        ...
        <Reveal className="border-t border-border pt-8">
          ...
          <div className="mt-10 grid gap-8 md:grid-cols-12 md:items-end">
            ...
            <div className="flex flex-wrap gap-7 md:col-span-5 md:justify-end">
              <Link href="#gallery" className="rv-editorial-link">{dictionary.closing.archiveCta}</Link>
              <Link href="#contact" className="rv-editorial-link">{dictionary.closing.contactCta}</Link>
            </div>
          </div>
        </Reveal>
      </Container>
